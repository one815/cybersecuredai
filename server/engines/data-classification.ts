  ...
  private initializeClassificationRules() {
    const rules: ClassificationRule[] = [
      ...
      },
      {
        ...
        priority: 150,
        conditions: [
          { field: "filename", operator: "regex", value: "(?i)(social[\\s._-]?security|ssn|ss[\\s._-]?card|passport|driver[\\s._-]?licen[sc]e|drivers[\\s._-]?licen[sc]e|dl|id[\\s._-]?card|identity|birth[\\s._-]?certificate|death[\\s._-]?certificate|marriage[\\s._-]?certificate|divorce[\\s._-]?certificate|adoption[\\s._-]?certificate|naturalization|citizenship|visa|green[\\s._-]?card|military[\\s._-]?id|cac[\\s._-]?card|common[\\s._-]?access|veterans[\\s._-]?id|state[\\s._-]?id|federal[\\s._-]?id|immigration|i-?94|i-?797|w-?2|1099|tax[\\s._-]?return|ein|tax[\\s._-]?id|business[\\s._-]?licen[sc]e|corporate|articles[\\s._-]?of[\\s._-]?incorporation|bylaws|operating[\\s._-]?agreement|partnership[\\s._-]?agreement|dba|doing[\\s._-]?business[\\s._-]?as|certificate[\\s._-]?of[\\s._-]?(formation|filing|incorporation)|shareholder[\\s._-]?agreement|board[\\s._-]?resolution|power[\\s._-]?of[\\s._-]?attorney|legal[\\s._-]?document|student[\\s._-]?id|school[\\s._-]?id|university[\\s._-]?id|college[\\s._-]?id|enrollment|transcript|diploma|degree|employee[\\s._-]?id|badge|payroll|personnel|hr[\\s._-]?record|employment[\\s._-]?verification|background[\\s._-]?check|security[\\s._-]?clearance|government[\\s._-]?id|federal[\\s._-]?employee|civil[\\s._-]?service|contractor[\\s._-]?badge|fips[\\s._-]?201)" },
          { field: "content", operator: "regex", value: "(?i)(social.security.card|social.security.administration|passport.number|driver.license.number|state.issued.id|birth.certificate|marriage.certificate|naturalization.certificate|certificate.of.citizenship|permanent.resident|green.card|military.identification|common.access.card|veterans.affairs|employer.identification.number|federal.tax.id|business.license|articles.of.incorporation|certificate.of.incorporation|certificate.of.formation|certificate.of.filing|corporate.bylaws|operating.agreement|partnership.agreement|shareholder.agreement|board.of.directors|power.of.attorney|student.identification|school.identification|university.transcript|academic.record|enrollment.verification|diploma|degree.certificate|employee.identification|personnel.record|payroll.information|employment.verification|background.investigation|security.clearance|government.employee|federal.employee.id|civil.service.record|contractor.identification|fips.201.compliant)" },

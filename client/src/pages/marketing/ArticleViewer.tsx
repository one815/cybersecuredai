...
const articleDatabase = {
  'the-evolving-regulatory-landscape-for-ai-security-a-cisos-guide-to-compliance': {
    title: 'The Evolving Regulatory Landscape for AI Security: A CISO\'s Guide to Compliance',
    description: 'Navigate the complex world of AI security regulations with this comprehensive guide covering key frameworks, implementation strategies, and best practices for effective AI governance.',
    sector: 'general',
    readTime: '16 min',

...
const articleDatabase = {
  'regulatory-compliance-for-ai-security-a-comprehensive-guide-for-cisos': {
    ...
    description: 'Navigate the complex world of AI security compliance with actionable insights, frameworks, and implementation strategies for effective regulatory management.',
    sector: 'general',
    readTime: '16 min',

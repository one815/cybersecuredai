    ...
    <div className="h-full bg-background">
      ...
      <main className="p-6 space-y-6">
        ...
        <Card className="bg-surface">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="text-white">Threat Analysis Visualization</CardTitle>
              <div className="flex items-center space-x-2">
          ...
          <CardContent>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              ...
              <Card className="bg-gray-800 border-gray-700">
                <CardHeader>
                  <CardTitle className="text-white text-lg">24-Hour Threat Timeline</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-gray-800 border-gray-700">
                <CardHeader>
                  <CardTitle className="text-white text-lg">Geographic Threat Intelligence</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <Card className="bg-gray-800 border-gray-700">
                <CardHeader>
                  <CardTitle className="text-white text-lg">Threat Correlation Matrix</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-gray-800 border-gray-700">
                <CardHeader>
                  <CardTitle className="text-white text-lg">Threat Forecast (Next 7 Days)</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {[
              ...
              <Card className="bg-gray-800 border-gray-700">
                <CardHeader>
                  <CardTitle className="text-white text-lg">Attack Pattern Analysis</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">

            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/solutions">
                <Button size="lg" className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white px-8 py-4 text-lg">
                  Explore Solutions
                  <div className="ml-2 w-6 h-4 bg-cover bg-no-repeat rounded" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '80% 50%', filter: 'contrast(1.2) saturate(1.3) brightness(1.1)'}} />
                </Button>
              </Link>
              <Link href="/security-scanner">
                <Button size="lg" variant="outline" className="border-cyan-500 text-cyan-400 hover:bg-cyan-500/10 px-8 py-4 text-lg">
                  Free Security Scan
                  <div className="ml-2 w-6 h-4 bg-cover bg-no-repeat rounded" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '20% 70%', filter: 'contrast(1.1) saturate(1.2) brightness(1.0)'}} />
                </Button>
              </Link>
            </div>
          </div>
                        ...
                        <div className="bg-gray-800/80 px-6 py-4 border-b border-cyan-500/20">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                              <div className="w-12 h-8 bg-cover bg-no-repeat rounded-lg" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '0% 20%', filter: 'contrast(1.3) saturate(1.4) brightness(0.9)'}} />
                              <div>
                          ...
                          <div className="grid grid-cols-3 gap-6">
                              ...
                              <div className="relative z-10">
                                <div className="flex items-center justify-between mb-4">
                                  <div className="flex items-center gap-3">
                                    <div className="w-16 h-12 bg-cover bg-no-repeat rounded-lg shadow-lg" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '15% 25%', filter: 'contrast(1.4) saturate(1.6) brightness(0.8)', boxShadow: '0 0 20px rgba(255, 0, 0, 0.3)'}} />
                            ...
                            <div className="bg-gray-800/40 rounded-xl p-6 border border-purple-500/30">
                              <div className="flex items-center gap-3 mb-4">
                                <div className="w-16 h-12 bg-cover bg-no-repeat rounded-lg shadow-lg" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '85% 75%', filter: 'contrast(1.3) saturate(1.5) brightness(0.9) hue-rotate(270deg)', boxShadow: '0 0 20px rgba(147, 51, 234, 0.3)'}} />
              ...
              <Card className="bg-surface/80 backdrop-blur-md border border-cyan-500/30 cyber-glow">
                <CardHeader>
                  <div className="w-12 h-12 bg-cyan-500/20 rounded-lg flex items-center justify-center mb-4">
                    <div className="w-8 h-6 bg-cover bg-no-repeat rounded-lg" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'contrast(1.4) saturate(1.6) brightness(0.8) hue-rotate(190deg)'}} />
                  </div>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-1 text-xs text-gray-300">
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Real-time detection and analysis</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Automated response protocols</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />5-minute MTTR</li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="bg-surface/80 backdrop-blur-md border border-red-500/30 cyber-glow">
                <CardHeader>
                  <div className="w-12 h-12 bg-red-500/20 rounded-lg flex items-center justify-center mb-4">
                    <div className="w-8 h-6 bg-cover bg-no-repeat rounded-lg" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '90% 10%', filter: 'contrast(1.5) saturate(1.4) brightness(0.7) hue-rotate(350deg)'}} />
                  </div>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-1 text-xs text-gray-300">
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Advanced threat classification</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Behavioral anomaly detection</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Threat hunting automation</li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="bg-surface/80 backdrop-blur-md border border-purple-500/30 cyber-glow">
                <CardHeader>
                  <div className="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center mb-4">
                    <div className="w-8 h-6 bg-cover bg-no-repeat rounded-lg" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '40% 60%', filter: 'contrast(1.2) saturate(1.7) brightness(1.0) hue-rotate(270deg)'}} />
                  </div>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-1 text-xs text-gray-300">
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Vulnerability prediction</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Risk scoring algorithms</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Proactive threat mitigation</li>
                  </ul>
                </CardContent>
              </Card>
            </div>
              ...
              <Card className="bg-surface/80 backdrop-blur-md border border-orange-500/30 cyber-glow">
                <CardHeader>
                  <div className="w-12 h-12 bg-orange-500/20 rounded-lg flex items-center justify-center mb-4">
                    <div className="w-8 h-6 bg-cover bg-no-repeat rounded-lg" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '60% 80%', filter: 'contrast(1.3) saturate(1.5) brightness(0.9) hue-rotate(30deg)'}} />
                  </div>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-1 text-xs text-gray-300">
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Next-generation firewall management</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Intrusion prevention systems</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Application-layer filtering</li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="bg-surface/80 backdrop-blur-md border border-green-500/30 cyber-glow">
                <CardHeader>
                  <div className="w-12 h-12 bg-green-500/20 rounded-lg flex items-center justify-center mb-4">
                    <div className="w-6 h-6 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '70% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />
                  </div>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-1 text-xs text-gray-300">
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Real-time performance monitoring</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Network traffic analysis</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Bandwidth optimization</li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="bg-surface/80 backdrop-blur-md border border-blue-500/30 cyber-glow">
                <CardHeader>
                  <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mb-4">
                    <div className="w-6 h-6 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '50% 10%', filter: 'hue-rotate(200deg) saturate(1.5) brightness(1.2)'}} />
                  </div>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-1 text-xs text-gray-300">
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Zero-trust security model</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Network segmentation</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />VPN configuration management</li>
                  </ul>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="bg-surface/80 backdrop-blur-md border border-cyan-500/30 cyber-glow">
                <CardHeader>
                  <div className="w-12 h-12 bg-cyan-500/20 rounded-lg flex items-center justify-center mb-4">
                    <div className="w-6 h-6 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '30% 70%', filter: 'hue-rotate(180deg) saturate(1.5) brightness(1.2)'}} />
                  </div>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-1 text-xs text-gray-300">
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />CPU, disk, memory monitoring</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Vulnerability scanning</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Automated remediation</li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="bg-surface/80 backdrop-blur-md border border-purple-500/30 cyber-glow">
                <CardHeader>
                  <div className="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center mb-4">
                    <div className="w-6 h-6 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '50% 40%', filter: 'hue-rotate(280deg) saturate(1.5) brightness(1.2)'}} />
                  </div>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-1 text-xs text-gray-300">
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Active Directory management</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />User account provisioning</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Group policy implementation</li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="bg-surface/80 backdrop-blur-md border border-red-500/30 cyber-glow">
                <CardHeader>
                  <div className="w-12 h-12 bg-red-500/20 rounded-lg flex items-center justify-center mb-4">
                    <div className="w-6 h-6 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '50% 70%', filter: 'hue-rotate(0deg) saturate(1.5) brightness(1.2)'}} />
                  </div>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-1 text-xs text-gray-300">
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />OS patch management</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Application updates</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />License and asset tracking</li>
                  </ul>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="bg-surface/80 backdrop-blur-md border border-green-500/30 cyber-glow">
                <CardHeader>
                  <div className="w-12 h-12 bg-green-500/20 rounded-lg flex items-center justify-center mb-4">
                    <div className="w-6 h-6 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />
                  </div>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-1 text-xs text-gray-300">
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />FERPA, COPPA, CIPA for education</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />FedRAMP, FISMA, NIST 800-53</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Automated audit reports</li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="bg-surface/80 backdrop-blur-md border border-orange-500/30 cyber-glow">
                <CardHeader>
                  <div className="w-12 h-12 bg-orange-500/20 rounded-lg flex items-center justify-center mb-4">
                    <div className="w-6 h-6 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '50% 90%', filter: 'hue-rotate(20deg) saturate(1.5) brightness(1.2)'}} />
                  </div>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-1 text-xs text-gray-300">
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Sector-specific training modules</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Phishing simulation campaigns</li>
                    <li className="flex items-center"><div className="w-3 h-3 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Progress tracking and reporting</li>
                  </ul>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="w-16 h-16 bg-red-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <div className="w-8 h-8 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 10%', filter: 'hue-rotate(0deg) saturate(1.5) brightness(1.2)'}} />
                </div>
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-purple-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <div className="w-8 h-8 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '50% 10%', filter: 'hue-rotate(280deg) saturate(1.5) brightness(1.2)'}} />
                </div>
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-green-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <div className="w-8 h-8 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '70% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />
                </div>
              ...
              <div>
                ...
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start">
                    <div className="w-5 h-5 mr-3 mt-0.5 flex-shrink-0 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="bg-surface/80 backdrop-blur-md border border-cyan-500/30 cyber-glow">
              ...
              <CardContent>
                ...
                <ul className="space-y-2 text-sm text-gray-300">
                  <li className="flex items-center"><div className="w-4 h-4 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Instant threat containment</li>
                  <li className="flex items-center"><div className="w-4 h-4 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Automated investigation</li>
                  <li className="flex items-center"><div className="w-4 h-4 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Smart remediation</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="bg-surface/80 backdrop-blur-md border border-green-500/30 cyber-glow">
              <CardHeader>
                <div className="w-12 h-12 bg-green-500/20 rounded-lg flex items-center justify-center mb-4">
                  <div className="w-6 h-6 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '70% 10%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />
                </div>
              ...
              <CardContent>
                ...
                <ul className="space-y-2 text-sm text-gray-300">
                  <li className="flex items-center"><div className="w-4 h-4 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Multi-framework support</li>
                  <li className="flex items-center"><div className="w-4 h-4 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Automated reporting</li>
                  <li className="flex items-center"><div className="w-4 h-4 mr-2 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 40%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />Audit trail management</li>
                </ul>
              </CardContent>
            </Card>
          </div>
            ...
            <Card className="bg-surface/80 backdrop-blur-md border border-blue-500/30 cyber-glow text-center">
              <CardContent className="p-8">
                <div className="w-16 h-16 bg-blue-500/20 rounded-lg flex items-center justify-center mx-auto mb-4">
                  <div className="w-8 h-8 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '50% 90%', filter: 'hue-rotate(200deg) saturate(1.5) brightness(1.2)'}} />
                </div>
            ...
            <Card className="bg-surface/80 backdrop-blur-md border border-purple-500/30 cyber-glow text-center">
              <CardContent className="p-8">
                <div className="w-16 h-16 bg-purple-500/20 rounded-lg flex items-center justify-center mx-auto mb-4">
                  <div className="w-8 h-8 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '50% 40%', filter: 'hue-rotate(280deg) saturate(1.5) brightness(1.2)'}} />
                </div>
            ...
            <Card className="bg-surface/80 backdrop-blur-md border border-orange-500/30 cyber-glow text-center">
              <CardContent className="p-8">
                <div className="w-16 h-16 bg-orange-500/20 rounded-lg flex items-center justify-center mx-auto mb-4">
                  <div className="w-8 h-8 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '70% 40%', filter: 'hue-rotate(20deg) saturate(1.5) brightness(1.2)'}} />
                </div>
            ...
            <Card className="bg-surface/80 backdrop-blur-md border border-red-500/30 cyber-glow text-center">
              <CardContent className="p-8">
                <div className="w-16 h-16 bg-red-500/20 rounded-lg flex items-center justify-center mx-auto mb-4">
                  <div className="w-8 h-8 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 90%', filter: 'hue-rotate(0deg) saturate(1.5) brightness(1.2)'}} />
                </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-cyan-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                  <div className="w-6 h-6 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '30% 40%', filter: 'hue-rotate(180deg) saturate(1.5) brightness(1.2)'}} />
                </div>
                <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-orange-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                  <div className="w-6 h-6 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '30% 90%', filter: 'hue-rotate(20deg) saturate(1.5) brightness(1.2)'}} />
                </div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-red-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                  <div className="w-6 h-6 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '10% 10%', filter: 'hue-rotate(0deg) saturate(1.5) brightness(1.2)'}} />
                </div>
                <div>
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/pricing">
              <Button size="lg" className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white px-8 py-4 text-lg">
                View Pricing Plans
                <div className="ml-2 w-5 h-5 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityImagesPath})`, backgroundPosition: '30% 90%', filter: 'brightness(1.2) saturate(1.5)'}} />
              </Button>
            </Link>
            <Link href="/about">
              <Button size="lg" variant="outline" className="border-cyan-500 text-cyan-400 hover:bg-cyan-500/10 px-8 py-4 text-lg">

    ...
    <MarketingLayout>
      <div className="solutions-light-bg min-h-screen">
          ...
          <div className="container mx-auto max-w-6xl text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/security-scanner">
                <Button size="lg" className="bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 px-12 py-4 text-lg text-white">
                  Free School Security Assessment
                </Button>
              </Link>
              <Link href="/solutions">
                <Button size="lg" variant="outline" className="border-green-500 text-green-600 hover:bg-green-50 px-12 py-4 text-lg">
                  View All Solutions
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <Card className="solutions-light-card">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="solutions-light-text font-semibold mb-1">Cost Savings</div>
                  <div className="solutions-light-muted text-sm">Vs traditional IT security</div>
                </CardContent>
              </Card>
              ...
              <Card className="solutions-light-card">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="solutions-light-muted text-sm">Student data protection</div>
                </CardContent>
              </Card>
              ...
              <Card className="solutions-light-card">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="solutions-light-text font-semibold mb-1">Network Efficiency</div>
                  <div className="solutions-light-muted text-sm">Optimized bandwidth</div>
                </CardContent>
              </Card>

              <Card className="solutions-light-card">
                <CardContent className="p-6 text-center">
                  <Database className="w-8 h-8 text-cyan-500 mx-auto mb-4" />
                  <div className="text-3xl font-bold text-cyan-500 mb-2">24/7</div>
                  <div className="solutions-light-text font-semibold mb-1">Student Safety</div>
        ...
        <section className="py-16 px-6 solutions-light-section">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-4xl font-bold solutions-light-text text-center mb-12">K-12 School District Protection</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {schoolDistricts.map((district, index) => (
                <Card key={index} className="solutions-light-card">
                  <CardHeader>
                    <CardTitle className="solutions-light-text text-lg">{district.district}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between text-sm">
                        <span className="solutions-light-muted">Students:</span>
                        <span className="solutions-light-text font-semibold">{district.students}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="solutions-light-muted">Devices:</span>
                        <span className="text-blue-500 font-semibold">{district.devices}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="solutions-light-muted">Security Score:</span>
                        <span className="text-green-500 font-semibold">{district.security_score}%</span>
                      </div>
        ...
        <section className="py-16 px-6">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-4xl font-bold solutions-light-text text-center mb-12">K-12 Threat Prevention Metrics</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <section className="py-16 px-6 solutions-light-section">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-4xl font-bold solutions-light-text text-center mb-12">K-12 Security Solutions</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {educationChallenges.map((challenge, index) => (
                <Card key={index} className="solutions-light-card">
                  <CardHeader>
                    <div className="flex items-center space-x-4 mb-4">
                      <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-blue-500 rounded-xl flex items-center justify-center text-white">
                        {challenge.icon}
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div className="text-center p-2 bg-gray-50 rounded">
                        <div className="text-sm font-bold text-green-500">{challenge.compliance}</div>
                        <div className="text-xs solutions-light-muted">Compliance</div>
                      </div>
                      <div className="text-center p-2 bg-gray-50 rounded">
                        <div className="text-sm font-bold text-blue-500">{challenge.protection}</div>
        ...
        <section className="py-20 px-6 bg-gradient-to-r from-green-50 to-blue-50">
          <div className="container mx-auto max-w-4xl text-center">
            <h2 className="text-5xl font-bold solutions-light-text mb-8">Protect Your Students & Schools</h2>

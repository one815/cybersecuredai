  ...
  const aiSolutions = [
    {
      ...
      icon: <div className="w-8 h-8 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityIconsPath})`, backgroundPosition: '50% 90%', filter: 'hue-rotate(180deg) saturate(1.5) brightness(1.2)'}} />
    },
    {
      ...
      icon: <div className="w-8 h-8 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityIconsPath})`, backgroundPosition: '30% 90%', filter: 'hue-rotate(280deg) saturate(1.5) brightness(1.2)'}} />
    },
    {
      ...
      icon: <div className="w-8 h-8 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityIconsPath})`, backgroundPosition: '50% 70%', filter: 'hue-rotate(20deg) saturate(1.5) brightness(1.2)'}} />
    }
  ];
  ...
  const complianceSolutions = [
    {
      ...
      icon: <div className="w-8 h-8 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${securityIconsPath})`, backgroundPosition: '70% 10%', filter: 'hue-rotate(120deg) saturate(1.5) brightness(1.2)'}} />
    },
    {
